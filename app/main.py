...
app = FastAPI(
    title="Gerador Confiável de Painéis",
    description="MVP administrativo para upload, inspeção determinística e publicação futura de painéis.",
    version="0.1.0",
)
app.mount("/published", StaticFiles(directory=PUBLISHED_DIR), name="published")
